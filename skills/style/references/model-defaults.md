...
literal verb loses nothing, record a finding. Review synonym cycling, triplets,
trailing analysis, closing summaries, uniform paragraph shapes, and decorative
bold in the same pass.
