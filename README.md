...
AI writing. Claude's skills fix what it finds, keep your voice
...
order does not change because moving bullets is cheap and moving
prose is not. You approve the outline, then a skeleton of the
argument, before Claude writes the rest. In a scripted or one-shot
...
Terse checks every file Claude writes or edits on its own. A
highlight page shows the flags in a browser. The checker and its
